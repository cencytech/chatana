					...
					<div class="info-box bg-default">
						...
						<div class="info-box-content">
							...
							<span class="progress-description">
								<input type="hidden" id="pass<?php echo $row['chatroomid']; ?>" value="<?php echo $row['chat_password']; ?>"><?php echo $row['chat_password']==null?"<i class='fa fa-unlock'></i> Open Chat" : "<i class='fa fa-lock'></i> Your PIN is: <strong class='label label-danger'>".$row['chat_password']; ?></strong>
							</span>
						</div>
					<!-- /.info-box-content -->
					</div>
