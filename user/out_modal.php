        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					...
					<span style="font-size: 11px;"><center><i>Note: Once you leave the group and you wanted to come back, password is needed for privacy.</i></center></span>
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-danger" id="confirm_leave2"><span class="glyphicon glyphicon-check"></span> Leave</button>
